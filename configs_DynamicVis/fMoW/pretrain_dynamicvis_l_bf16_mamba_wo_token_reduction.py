...
work_dir = 'work_dirs/fMoW/pretrain_dynamicvis_l_bf16_mamba_wo_token_reduction'

# data_root = f'/mnt/nlp-ali/dataset/cky_data/fmow-rgb-tar'
# code_root = f'/mnt/nlp-ali/usr/chenkeyan/codes/dynamicvis'
data_root = f'/mnt/ali-sh-1/dataset/cky_data/fmow-rgb-tar'
code_root = f'/mnt/ali-sh-1/usr/chenkeyan/codes/dynamicvis'
