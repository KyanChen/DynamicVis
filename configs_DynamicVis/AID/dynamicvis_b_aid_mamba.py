...
work_dir = 'work_dirs/AID/dynamicvis_b_aid_mamba'
data_root = '/mnt/nlp-ali/dataset/cky_data/AID'
code_root = '/mnt/nlp-ali/usr/chenkeyan/codes/dynamicvis'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='dynamicvis', group='AID', name=work_dir.split('/')[-1]))
                ]
...
train_cfg = dict(by_epoch=True, max_epochs=500, val_interval=val_interval)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_name='AID',
        data_root=data_root,
        ann_file=code_root+'/datainfo/aid/train.txt',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_name='AID',
        data_root=data_root,
        ann_file=code_root+'/datainfo/aid/val.txt',
