...
work_dir = 'work_dirs/NWPU/dynamicvis_b_nwpu_mamba'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file=code_root + '/datainfo/nwpu/NWPU_instances_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=indices,
        data_root=data_root,
        ann_file=code_root + '/datainfo/nwpu/NWPU_instances_val.json',
        data_prefix=dict(img='imgs'),
        test_mode=True,
