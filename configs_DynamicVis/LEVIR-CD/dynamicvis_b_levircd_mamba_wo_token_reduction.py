...
work_dir = 'work_dirs/LEVIR-CD/dynamicvis_b_levircd_mamba_wo_token_reduction'
...
test_pipeline = [
    dict(type='MultiImgLoadImageFromFile'),
    dict(type='MultiImgResize', scale=(1024, 1024), keep_ratio=True, interpolation='bicubic'),
