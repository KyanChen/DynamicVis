...
work_dir = 'work_dirs/WHU-CD/dynamicvis_b_2X_whucd_mamba'
data_root = '/mnt/search01/dataset/cky_data/WHUCD-256'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='dynamicvis', group='WHU-CD', name=work_dir.split('/')[-1]))
                ]
