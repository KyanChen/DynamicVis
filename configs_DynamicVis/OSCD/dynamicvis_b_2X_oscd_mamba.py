...
work_dir = 'work_dirs/OSCD/dynamicvis_b_2X_oscd_mamba'
data_root = '/mnt/search01/dataset/cky_data/OSCD_256'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='dynamicvis', group='OSCD', name=work_dir.split('/')[-1]))
                ]
...
test_pipeline = [
    dict(type='MultiImgLoadImageFromFile'),
    dict(type='MultiImgResize', scale=(input_size, input_size), keep_ratio=True, interpolation='bicubic'),
