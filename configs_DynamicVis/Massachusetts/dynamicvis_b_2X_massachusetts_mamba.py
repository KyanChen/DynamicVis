...
work_dir = 'work_dirs/Massachusetts/dynamicvis_b_2X_massachusetts_mamba'
data_root = '/mnt/nj-larc/dataset/cky_data/MassachusettsRoads/tiff'
...
dataset_type = 'MassachusettsRoadsSegDataset'
val_interval = 10
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='dynamicvis', group='Massachusetts', name=work_dir.split('/')[-1]))
                ]
...
train_cfg = dict(by_epoch=True, max_epochs=1200, val_interval=val_interval)
...
train_pipeline = [
    ...
    dict(type='Resize', scale=(1500*2, 1500*2), keep_ratio=True, interpolation='bicubic'),
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='Resize', scale=(1500*2, 1500*2), keep_ratio=True),
